...
> **BART-base** is the sweet spot for a portfolio project — it's powerful enough to produce impressive results, light enough to fine-tune without a cluster, and well-documented in the HuggingFace ecosystem.
...
| Setup & EDA | 1 day |
| Preprocessing | 1 day |
| Fine-Tuning | 2–3 days (GPU dependent) |
| Evaluation | 1 day |
| Gradio App | 1 day |
| Publishing | 1 day |
| **Total** | **~1 week** |
